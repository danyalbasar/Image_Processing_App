...
def recalc():
	try:
		perc_temp = ent_5.get()
		if (not perc_temp.isdigit()) or (len(perc_temp) == 0) or (int(perc_temp) < 0):
...
font_2 = ("arial", 15, "bold")
font_3 = ("arial", 13, "bold")
color_1 = "yellow"
color_2 = "black"
 
wrapper = LabelFrame(main_window, text="Source File", font=font_2, fg="yellow", bg="black")
wrapper.pack(fill="both", expand="yes", padx=20, pady=20)
 
lbl = Label(wrapper, text="Source File", font=font_2, fg="yellow", bg="black")
lbl.pack(side=LEFT, padx=10, pady=10)
 
ent = Entry(wrapper, textvariable=t1, bd=3.5, bg="yellow", font=font_3, width= 32)
ent.pack(side=LEFT, padx=10, pady=10, ipady=5)
 
btn = Button(wrapper, text="Browse", command=browse_img, width=8, bg="yellow", font=font_2, bd=3.5)
btn.pack(side=LEFT, padx=10, pady=10)
 
btn_2 = Button(wrapper, text="Preview", command=preview_img, width=8, bg="yellow", font=font_2, bd=3.5)
btn_2.pack(side=LEFT, padx=10, pady=10)
 
wrapper_2 = LabelFrame(main_window, text="Image Details", font=font_2, fg="yellow", bg="black")
wrapper_2.pack(fill="both", expand="yes", padx=20, pady=20)
 
lbl_2 = Label(wrapper_2, text="Dimension:", font=font_2, fg="yellow", bg="black")
lbl_2.pack(side=LEFT, padx=10, pady=10)
 
ent_2 = Entry(wrapper_2, textvariable=w, bd=3.5, bg="yellow", font=font_3, width=10)
ent_2.pack(side=LEFT, padx=10, pady=10, ipady=5)
 
lbl_3 = Label(wrapper_2, text="X", font=font_2, fg="yellow", bg="black")
lbl_3.pack(side=LEFT, padx=10, pady=10)
 
ent_3 = Entry(wrapper_2, textvariable=h, bd=3.5, bg="yellow", font=font_3, width=10)
ent_3.pack(side=LEFT, padx=10, pady=10, ipady=5)

lbl_4 = Label(wrapper_2, text="Image Type:", font=font_2, fg="yellow", bg="black")
lbl_4.pack(side=LEFT, padx=10, pady=10)

ent_4 = Entry(wrapper_2, textvariable=img_type, bd=3.5, bg="yellow", font=font_3, width=10)
ent_4.bind("<Key>", lambda a: "break")
ent_4.pack(side=LEFT, padx=10, pady=10, ipady=5)

wrapper_3 = LabelFrame(main_window, text="Pixel Safe", font=font_2, fg="yellow", bg="black")
wrapper_3.pack(fill="both", expand="yes", padx=20, pady=20)
 
lbl_5 = Label(wrapper_3, text="Percentage:",font=font_2, fg="yellow", bg="black")
lbl_5.pack(side=LEFT, padx=10, pady=10)
 
ent_5 = Entry(wrapper_3, textvariable=perc, bd=3.5, bg="yellow", font=font_3, width=10)
ent_5.pack(side=LEFT, padx=10, pady=10, ipady=5)

lbl_6 = Label(wrapper_3, text="%", font=font_2, fg="yellow", bg="black")
lbl_6.pack(side=LEFT, padx=10, pady=10)
 
btn_3 = Button(wrapper_3, text="Recalculate Dimension", command=recalc, font=font_2, bg="yellow", bd=3.5)
btn_3.pack(side=LEFT, padx=10, pady=10)

wrapper_4 = LabelFrame(main_window, text="Changes", font=font_2, fg="yellow", bg="black")
wrapper_4.pack(fill="both", expand="yes", padx=20, pady=20)

lbl_7 = Label(wrapper_4, text="Quality:", font=font_2, fg="yellow", bg="black")
lbl_7.pack(side=LEFT, padx=10, pady=10)

ent_6 = Entry(wrapper_4, textvariable=qua, bd=3.5, bg="yellow", font=font_3, width=10)
ent_6.pack(side=LEFT, padx=10, pady=10, ipady=5)

lbl_8 = Label(wrapper_4, text="%", font=font_2, fg="yellow", bg="black")
lbl_8.pack(side=LEFT, padx=10, pady=10)

lbl_9 = Label(wrapper_4, text="Image type:", font=font_2, fg="yellow", bg="black")
...
combo_resize = ttk.Combobox(wrapper_4, textvariable=option, style='combo_resize.TCombobox', font=font_3, width=7)
combo_resize["values"] = [".jpg", ".jpeg", ".png", ".pdf"]
combo_resize.bind("<Key>", lambda a: "break")
combo_resize.option_add("*TCombobox*Listbox*Font", font_3)
...
wrapper_5 = LabelFrame(main_window, text="Actions", font=font_2, fg="yellow", bg="black")
wrapper_5.pack(fill="both", expand="yes", padx=20, pady=20)
 
btn_4 = Button(wrapper_5, text="Preview", command=preview_new_img, width=8, font=font_2, bg="yellow", bd=3.5)
btn_4.pack(side=LEFT, padx=10, pady=10)
 
btn_5 = Button(wrapper_5, text="Save", command=save_new_img, width=8, font=font_2, bg="yellow", bd=3.5)
btn_5.pack(side=LEFT, padx=10, pady=10)
 
btn_6 = Button(wrapper_5, text="Clear", command=clear_all, width=8, font=font_2, bg="yellow", bd=3.5)
btn_6.pack(side=LEFT, padx=10, pady=10)

btn_7 = Button(wrapper_5, text="Exit", bd=3.5, width=8, font=font_2, bg="yellow", command=lambda: exit())
